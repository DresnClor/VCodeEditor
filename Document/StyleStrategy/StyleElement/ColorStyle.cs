...
namespace VCodeEditor.Document
{
    ...
    public class ColorStyle
    {
        ...
        /// 从xml元素创建高亮颜色
        /// </summary>
        public ColorStyle(XmlElement el)
        {
        ...
        /// </summary>
        public ColorStyle(XmlElement el, ColorStyle defaultColor)
        {
            Debug.Assert(el != null, "VCodeEditor.Document.SyntaxColor(XmlElement el) : el == null");
            if (el.Attributes["name"] != null)
            {//名称
        ...
        /// <summary>
        /// Creates a new instance of <see cref="ColorStyle"/>
        /// </summary>
        public ColorStyle(Color color, bool bold, bool italic)
        {
            hasForgeground = true;
            this.color = color;
            this.bold = bold;
        ...
        /// Creates a new instance of <see cref="ColorStyle"/>
        /// </summary>
        public ColorStyle(Color color, Color backgroundcolor, bool bold, bool italic)
        {
            hasForgeground = true;
            hasBackground = true;
            this.color = color;
        ...
        /// Creates a new instance of <see cref="ColorStyle"/>
        /// </summary>
        public ColorStyle(string systemColor, string systemBackgroundColor, bool bold, bool italic)
        {
            hasForgeground = true;
            hasBackground = true;
        ...
        /// <summary>
        /// Converts a <see cref="ColorStyle"/> instance to string (for debug purposes)
        /// </summary>

...
namespace VCodeEditor.Gui.InsightWindow
{
	...
	/// 洞察窗口
	/// </summary>
	public class InsightWindow : AbstCompleWindow
	{
		...
		protected override void CaretOffsetChanged(object sender, EventArgs e)
		{
			...
			int rulerHeight = control.Property.ShowHorizontalRuler ? control.ActiveTextAreaControl.TextArea.TextView.FontHeight : 0;
		...
		public void HandleMouseWheel(MouseEventArgs e)
		{
			if (DataProvider != null && DataProvider.InsightDataCount > 0) {
				if (e.Delta > 0) {
					if (control.Property.MouseWheelScrollDown) {
						CurrentData = (CurrentData + 1) % DataProvider.InsightDataCount;
					} else {
						CurrentData = (CurrentData + DataProvider.InsightDataCount - 1) % DataProvider.InsightDataCount;
					}

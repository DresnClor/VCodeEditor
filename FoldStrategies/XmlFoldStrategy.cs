...
namespace VCodeEditor.FoldStrategies
{
	...
	/// XML折叠策略
	/// </summary>
	public class XmlFoldStrategy : IFoldingStrategy
	{
		public XmlFoldStrategy()
		{
		}
		...
		public List<FoldMarker> GenerateFoldMarkers(IDocument document, string fileName, object parseInformation)
		{
			...
			try
			{
				...
				System.Xml.XmlTextReader reader = new System.Xml.XmlTextReader(new StringReader(xml));
				while (reader.Read())
				{
		...
		void CreateCommentFold(IDocument document, List<FoldMarker> foldMarkers, System.Xml.XmlTextReader reader)
		{
		...
		/// </summary>
		XmlFoldStart CreateElementFoldStart(System.Xml.XmlTextReader reader)
		{
		...
		/// different lines.
		/// </summary>
		void CreateElementFold(IDocument document, List<FoldMarker> foldMarkers, System.Xml.XmlTextReader reader, XmlFoldStart foldStart)
		{
		...
		/// </remarks>
		string GetAttributeFoldText(System.Xml.XmlTextReader reader)
		{
